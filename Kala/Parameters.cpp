...
// Force Hexa-X frame
// Force Hexa-X frame
#define FORCE_FRAME_CLASS 2   // 1 = Hexa
#define FORCE_FRAME_TYPE  1   // 1 = X

#if defined(FORCE_FRAME_CLASS)
#define DEFAULT_FRAME_CLASS FORCE_FRAME_CLASS
#elif FRAME_CONFIG == HELI_FRAME
#define DEFAULT_FRAME_CLASS 1
#else
#define DEFAULT_FRAME_CLASS 2   // Hexa
#endif
...
//#ifndef FORCE_FRAME_TYPE
// @Param: FRAME_TYPE
// @DisplayName: Frame Type (+, X, V, etc)
// @Description: Multirotor arm layout
// @Values: 0:Plus, 1:X
// @User: Standard
// @RebootRequired: True
GSCALAR(frame_type, "FRAME_TYPE", 1),// default = X
//#endif
...
//#ifndef FORCE_FRAME_CLASS
// @Param: FRAME_CLASS
// @DisplayName: Frame Class
// @Description: Type of frame (e.g., Quad, Hexa, Octa)
// @Values: 1:Quad
// @User: Standard
// @RebootRequired: True
...
// === Enforce Hexa-X params on boot and send to GCS ===
#if defined(FORCE_FRAME_CLASS)
    g2.frame_class.set_and_save(FORCE_FRAME_CLASS);
    g2.frame_class.notify();
#endif
#if defined(FORCE_FRAME_TYPE)
    g.frame_type.set_and_save(FORCE_FRAME_TYPE);
    g.frame_type.notify();
#endif
}
