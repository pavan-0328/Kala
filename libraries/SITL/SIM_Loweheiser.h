...
./Tools/autotest/sim_vehicle.py --gdb --debug -v Kala -A --serial5=sim:loweheiser --speedup=1 --console
...
./Tools/autotest/sim_vehicle.py --gdb --debug -v Kala -A --serial5=uart:$DEV:115200 --speedup=1 --console
