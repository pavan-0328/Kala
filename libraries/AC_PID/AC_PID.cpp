    ...
    default_slew_rate_max(initial_srmax)
{
    ...
    _target_notch = nullptr; //setting null pointer
    _error_notch = nullptr;
    _derivative = 0.0f;      //setting default value of derivative
    _target_derivative = 0.0f;
    _integrator = 0.0f;      //setting default value of integrator
    _error = 0.0f;           //setting default value of error
    _target = 0.0f;          //setting default value of target
