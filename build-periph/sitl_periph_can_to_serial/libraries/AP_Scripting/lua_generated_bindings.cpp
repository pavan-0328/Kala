...
#if APM_BUILD_TYPE(APM_BUILD_Kala)
#include <AP_Motors/AP_MotorsMatrix_6DoF_Scripting.h>
#endif // APM_BUILD_TYPE(APM_BUILD_Kala)
#if APM_BUILD_TYPE(APM_BUILD_Kala)
...
DroneCAN_Handle * new_DroneCAN_Handle(lua_State *L) {
    void *ud = lua_newuserdata(L, sizeof(DroneCAN_Handle));
    new (ud) DroneCAN_Handle();
    luaL_getmetatable(L, "DroneCAN_Handle");
    lua_setmetatable(L, -2);
    return (DroneCAN_Handle *)ud;
}
#endif // HAL_ENABLE_DRONECAN_DRIVERS

#if AP_SERVO_TELEM_ENABLED
AP_Servo_Telem::TelemetryData * new_AP_Servo_Telem__TelemetryData(lua_State *L) {
    void *ud = lua_newuserdata(L, sizeof(AP_Servo_Telem::TelemetryData));
    new (ud) AP_Servo_Telem::TelemetryData();
    luaL_getmetatable(L, "AP_Servo_Telem_Data");
    lua_setmetatable(L, -2);
    return (AP_Servo_Telem::TelemetryData *)ud;
}
#endif // AP_SERVO_TELEM_ENABLED
...
CRSFMenu * new_CRSFMenu(lua_State *L) {
...
#if AP_CRSF_SCRIPTING_ENABLED
CRSFParameter * new_CRSFParameter(lua_State *L) {
    void *ud = lua_newuserdata(L, sizeof(CRSFParameter));
    new (ud) CRSFParameter();
    luaL_getmetatable(L, "CRSFParameter");
    lua_setmetatable(L, -2);
    return (CRSFParameter *)ud;
}

int lua_new_CRSFParameter(lua_State *L) {
    static bool warned = false;
    if (!warned && userdata_zero_arg_check(L)) {
        warned = true;
    }
...
#if HAL_ENABLE_DRONECAN_DRIVERS
DroneCAN_Handle * check_DroneCAN_Handle(lua_State *L, int arg) {
    return (DroneCAN_Handle *)luaL_checkudata(L, arg, "DroneCAN_Handle");
}
#endif // HAL_ENABLE_DRONECAN_DRIVERS

#if AP_SERVO_TELEM_ENABLED
AP_Servo_Telem::TelemetryData * check_AP_Servo_Telem__TelemetryData(lua_State *L, int arg) {
    return (AP_Servo_Telem::TelemetryData *)luaL_checkudata(L, arg, "AP_Servo_Telem_Data");
}
#endif // AP_SERVO_TELEM_ENABLED
...
#if AP_CRSF_SCRIPTING_ENABLED
CRSFMenu * check_CRSFMenu(lua_State *L, int arg) {
    return (CRSFMenu *)luaL_checkudata(L, arg, "CRSFMenu");
}
#endif // AP_CRSF_SCRIPTING_ENABLED

#if AP_CRSF_SCRIPTING_ENABLED
CRSFParameter * check_CRSFParameter(lua_State *L, int arg) {
    return (CRSFParameter *)luaL_checkudata(L, arg, "CRSFParameter");
}
#endif // AP_CRSF_SCRIPTING_ENABLED
...
#if (!defined(HAL_BUILD_AP_PERIPH))
AP_Vehicle::custom_mode_state ** new_AP_Vehicle__custom_mode_state(lua_State *L) {
    return (AP_Vehicle::custom_mode_state **)new_ap_object(L, sizeof(AP_Vehicle::custom_mode_state *), "AP_Vehicle::custom_mode_state");
}
#endif // (!defined(HAL_BUILD_AP_PERIPH))
...
#if (!defined(HAL_BUILD_AP_PERIPH))
AP_Vehicle::custom_mode_state ** check_AP_Vehicle__custom_mode_state(lua_State *L, int arg) {
    return (AP_Vehicle::custom_mode_state **)check_ap_object(L, arg, "AP_Vehicle::custom_mode_state");
}
#endif // (!defined(HAL_BUILD_AP_PERIPH))
...
#if AP_SERVO_TELEM_ENABLED
AP_Servo_Telem * check_AP_Servo_Telem(lua_State *L) {
    AP_Servo_Telem * ud = AP_Servo_Telem::get_singleton();
    if (ud == nullptr) {
        // This error will never return, so there is no danger of returning a nullptr
        not_supported_error(L, 1, "servo_telem");
    }
    return ud;
}
#endif // AP_SERVO_TELEM_ENABLED
...
#if (!defined(HAL_BUILD_AP_PERIPH) || AP_PERIPH_RC_OUT_ENABLED)
...
#endif // (!defined(HAL_BUILD_AP_PERIPH) || AP_PERIPH_RC_OUT_ENABLED)
...
#if (!defined(HAL_BUILD_AP_PERIPH) || AP_PERIPH_NOTIFY_ENABLED)
...
#endif // (!defined(HAL_BUILD_AP_PERIPH) || AP_PERIPH_NOTIFY_ENABLED)
...
#if AP_SERVO_TELEM_ENABLED
static int AP_Servo_Telem_get_telem(lua_State *L) {
    binding_argcheck(L, 2);
    AP_Servo_Telem * ud = check_AP_Servo_Telem(L);
    const uint8_t raw_data_2 = get_uint8_t(L, 2);
    const uint8_t data_2 = static_cast<uint8_t>(raw_data_2);
    AP_Servo_Telem::TelemetryData data_5003 {};
    const bool data = static_cast<bool>(ud->get_telem(
            data_2,
            data_5003));
    ...
    if (data) {
        ...
        *new_AP_Servo_Telem__TelemetryData(L) = data_5003;
        return 1;
    }
    return 0;
}
...
#if AP_NETWORKING_ENABLED
static int AP_Networking_add_route(lua_State *L) {
    ...
    const bool data = static_cast<bool>(ud->add_route(
            data_2,
            data_3,
            data_4,
            data_5));
...
#if AP_FENCE_ENABLED
static int AC_Fence_get_breach_distance(lua_State *L) {
    binding_argcheck(L, 2);
    AC_Fence * ud = check_AC_Fence(L);
    const uint8_t raw_data_2 = get_uint8_t(L, 2);
    const uint8_t data_2 = static_cast<uint8_t>(raw_data_2);
    const float data = static_cast<float>(ud->get_breach_distance(
            data_2));
...
#if AP_FENCE_ENABLED
static int AC_Fence_get_margin_breach_time(lua_State *L) {
    binding_argcheck(L, 1);
    AC_Fence * ud = check_AC_Fence(L);
    const uint32_t data = static_cast<uint32_t>(ud->get_margin_breach_time());
...
#if AP_FENCE_ENABLED
static int AC_Fence_get_margin_breaches(lua_State *L) {
    binding_argcheck(L, 1);
    AC_Fence * ud = check_AC_Fence(L);
    const uint8_t data = static_cast<uint8_t>(ud->get_margin_breaches());
...
#if APM_BUILD_COPTER_OR_HELI
static int AC_PosControl_get_accel_target(lua_State *L) {
    binding_argcheck(L, 1);
    AC_PosControl * ud = check_AC_PosControl(L);
    Vector3f data_5002 {};
    const bool data = static_cast<bool>(ud->get_accel_target(
            data_5002));
...
#if APM_BUILD_COPTER_OR_HELI
static int AC_PosControl_get_vel_target(lua_State *L) {
    binding_argcheck(L, 1);
    AC_PosControl * ud = check_AC_PosControl(L);
    Vector3f data_5002 {};
    const bool data = static_cast<bool>(ud->get_vel_target(
            data_5002));
...
static int RC_Channels_run_aux_function(lua_State *L) {
    ...
    const bool data = static_cast<bool>(ud->run_aux_function(
            data_2,
            data_3,
            RC_Channel::AuxFuncTrigger::Source::SCRIPTING,
            0));
...
static int SRV_Channels_set_range(lua_State *L) {
    ...
    const SRV_Channel::Function data_2 = static_cast<SRV_Channel::Function>(raw_data_2);
    const uint16_t raw_data_3 = get_uint16_t(L, 3);
    const uint16_t data_3 = static_cast<uint16_t>(raw_data_3);
    ud->set_range(
            data_2,
...
#if (!defined(HAL_BUILD_AP_PERIPH))
static int AP_Vehicle_register_custom_mode(lua_State *L) {
    binding_argcheck(L, 4);
    ...
    AP::scheduler().get_semaphore().take_blocking();
#endif
    AP_Vehicle::custom_mode_state *data = ud->register_custom_mode(
            data_2,
            data_3,
            data_4);
    ...
    *new_AP_Vehicle__custom_mode_state(L) = data;
    return 1;
}
#endif // (!defined(HAL_BUILD_AP_PERIPH))
...
#if (HAL_GCS_ENABLED && !defined(HAL_BUILD_AP_PERIPH))
static int GCS_set_allow_param_set(lua_State *L) {
    binding_argcheck(L, 2);
    GCS * ud = check_GCS(L);
    const bool data_2 = static_cast<bool>(lua_toboolean(L, 2));
    ud->set_allow_param_set(
            data_2);
...
#if (HAL_GCS_ENABLED && !defined(HAL_BUILD_AP_PERIPH))
static int GCS_get_allow_param_set(lua_State *L) {
    binding_argcheck(L, 1);
    GCS * ud = check_GCS(L);
    const bool data = static_cast<bool>(ud->get_allow_param_set());
...
#if (HAL_GCS_ENABLED && !defined(HAL_BUILD_AP_PERIPH))
static int GCS_sysid_mygcs_last_seen_time_ms(lua_State *L) {
    binding_argcheck(L, 1);
    GCS * ud = check_GCS(L);
    const uint32_t data = static_cast<uint32_t>(ud->sysid_mygcs_last_seen_time_ms());
...
#if (HAL_GCS_ENABLED && !defined(HAL_BUILD_AP_PERIPH))
static int GCS_send_named_string(lua_State *L) {
    binding_argcheck(L, 3);
    GCS * ud = check_GCS(L);
    const char * data_2 = luaL_checkstring(L, 2);
    const char * data_3 = luaL_checkstring(L, 3);
    ud->send_named_string(
            data_2,
            data_3);
...
#if AP_RANGEFINDER_ENABLED
static int RangeFinder_ground_clearance_orient(lua_State *L) {
    binding_argcheck(L, 2);
    RangeFinder * ud = check_RangeFinder(L);
    const lua_Integer raw_data_2 = get_integer(L, 2, static_cast<int32_t>(ROTATION_NONE), static_cast<int32_t>(ROTATION_MAX-1));
    const Rotation data_2 = static_cast<Rotation>(raw_data_2);
    const float data = static_cast<float>(ud->ground_clearance_orient(
            data_2));
...
#if AP_RANGEFINDER_ENABLED
static int RangeFinder_min_distance_orient(lua_State *L) {
    binding_argcheck(L, 2);
    RangeFinder * ud = check_RangeFinder(L);
    const lua_Integer raw_data_2 = get_integer(L, 2, static_cast<int32_t>(ROTATION_NONE), static_cast<int32_t>(ROTATION_MAX-1));
    const Rotation data_2 = static_cast<Rotation>(raw_data_2);
    const float data = static_cast<float>(ud->min_distance_orient(
            data_2));
...
#if AP_RANGEFINDER_ENABLED
static int RangeFinder_max_distance_orient(lua_State *L) {
    binding_argcheck(L, 2);
    RangeFinder * ud = check_RangeFinder(L);
    const lua_Integer raw_data_2 = get_integer(L, 2, static_cast<int32_t>(ROTATION_NONE), static_cast<int32_t>(ROTATION_MAX-1));
    const Rotation data_2 = static_cast<Rotation>(raw_data_2);
    const float data = static_cast<float>(ud->max_distance_orient(
            data_2));
...
static int RangeFinder_ground_clearance_cm_orient(lua_State *L) {
    static bool warned = false;
    if (!warned) {
        lua_scripts::set_and_print_new_error_message(MAV_SEVERITY_WARNING, "rangefinder:ground_clearance_cm_orient Use ground_clearance_orient (in metres)");
        warned = true;
    }
...
static int RangeFinder_min_distance_cm_orient(lua_State *L) {
    static bool warned = false;
    if (!warned) {
        lua_scripts::set_and_print_new_error_message(MAV_SEVERITY_WARNING, "rangefinder:min_distance_cm_orient Use min_distance_orient (in metres)");
        warned = true;
    }
    ...
    const lua_Integer raw_data_2 = get_integer(L, 2, static_cast<int32_t>(ROTATION_NONE), static_cast<int32_t>(ROTATION_MAX-1));
    const Rotation data_2 = static_cast<Rotation>(raw_data_2);
    const int32_t data = static_cast<int32_t>(ud->min_distance_cm_orient(
            data_2));
...
static int RangeFinder_max_distance_cm_orient(lua_State *L) {
    static bool warned = false;
    if (!warned) {
        lua_scripts::set_and_print_new_error_message(MAV_SEVERITY_WARNING, "rangefinder:max_distance_cm_orient Use max_distance_orient (in metres)");
        warned = true;
    }
    ...
    const lua_Integer raw_data_2 = get_integer(L, 2, static_cast<int32_t>(ROTATION_NONE), static_cast<int32_t>(ROTATION_MAX-1));
    const Rotation data_2 = static_cast<Rotation>(raw_data_2);
    const int32_t data = static_cast<int32_t>(ud->max_distance_cm_orient(
            data_2));
...
#if AP_RANGEFINDER_ENABLED
static int RangeFinder_distance_orient(lua_State *L) {
    binding_argcheck(L, 2);
    RangeFinder * ud = check_RangeFinder(L);
    const lua_Integer raw_data_2 = get_integer(L, 2, static_cast<int32_t>(ROTATION_NONE), static_cast<int32_t>(ROTATION_MAX-1));
    const Rotation data_2 = static_cast<Rotation>(raw_data_2);
    const float data = static_cast<float>(ud->distance_orient(
            data_2));
...
static int RangeFinder_distance_cm_orient(lua_State *L) {
    static bool warned = false;
    if (!warned) {
        lua_scripts::set_and_print_new_error_message(MAV_SEVERITY_WARNING, "rangefinder:distance_cm_orient Use distance_orient (in metres)");
        warned = true;
    }
...
#if AP_AHRS_ENABLED
static int AP_AHRS_get_relative_position_NED_origin_float(lua_State *L) {
    binding_argcheck(L, 1);
    AP_AHRS * ud = check_AP_AHRS(L);
    Vector3f data_5002 {};
    ud->get_semaphore().take_blocking();
    const bool data = static_cast<bool>(ud->get_relative_position_NED_origin_float(
            data_5002));
...
static int AP_AHRS_get_yaw(lua_State *L) {
    static bool warned = false;
    if (!warned) {
        lua_scripts::set_and_print_new_error_message(MAV_SEVERITY_WARNING, "ahrs:get_yaw Use get_yaw_rad");
        warned = true;
    }
...
#if AP_AHRS_ENABLED
static int AP_AHRS_get_yaw_rad(lua_State *L) {
    binding_argcheck(L, 1);
    AP_AHRS * ud = check_AP_AHRS(L);
    ud->get_semaphore().take_blocking();
    const float data = static_cast<float>(ud->get_yaw_rad());
...
static int AP_AHRS_get_pitch(lua_State *L) {
    static bool warned = false;
    if (!warned) {
        lua_scripts::set_and_print_new_error_message(MAV_SEVERITY_WARNING, "ahrs:get_pitch Use get_pitch_rad");
        warned = true;
    }
...
#if AP_AHRS_ENABLED
static int AP_AHRS_get_pitch_rad(lua_State *L) {
    binding_argcheck(L, 1);
    AP_AHRS * ud = check_AP_AHRS(L);
    ud->get_semaphore().take_blocking();
    const float data = static_cast<float>(ud->get_pitch_rad());
...
static int AP_AHRS_get_roll(lua_State *L) {
    static bool warned = false;
    if (!warned) {
        lua_scripts::set_and_print_new_error_message(MAV_SEVERITY_WARNING, "ahrs:get_roll Use get_roll_rad");
        warned = true;
    }
...
#if AP_AHRS_ENABLED
static int AP_AHRS_get_roll_rad(lua_State *L) {
    binding_argcheck(L, 1);
    AP_AHRS * ud = check_AP_AHRS(L);
    ud->get_semaphore().take_blocking();
    const float data = static_cast<float>(ud->get_roll_rad());
...
#if AP_SERVO_TELEM_ENABLED
const luaL_Reg AP_Servo_Telem_meta[] = {
    {"get_telem", AP_Servo_Telem_get_telem},
};

static int AP_Servo_Telem_index(lua_State *L) {
    return load_function(L,AP_Servo_Telem_meta,ARRAY_SIZE(AP_Servo_Telem_meta));
}
#endif // AP_SERVO_TELEM_ENABLED
...
const luaL_Reg AP_Networking_meta[] = {
    {"add_route", AP_Networking_add_route},
...
const luaL_Reg AC_Fence_meta[] = {
    {"get_breach_distance", AC_Fence_get_breach_distance},
    {"get_margin_breach_time", AC_Fence_get_margin_breach_time},
    {"get_margin_breaches", AC_Fence_get_margin_breaches},
...
const luaL_Reg AC_PosControl_meta[] = {
    {"get_accel_target", AC_PosControl_get_accel_target},
    {"get_vel_target", AC_PosControl_get_vel_target},
...
#if AP_CRSF_SCRIPTING_ENABLED
const luaL_Reg AP__crsf_telem___meta[] = {
    {"send_write_response", lua_CRSF_send_response},
    {"get_menu_event", lua_CRSF_get_menu_event},
    {"add_menu", lua_CRSF_add_root_menu},
};

static int AP__crsf_telem___index(lua_State *L) {
    return load_function(L,AP__crsf_telem___meta,ARRAY_SIZE(AP__crsf_telem___meta));
}
#endif // AP_CRSF_SCRIPTING_ENABLED
...
const luaL_Reg AP_Vehicle_meta[] = {
    {"register_custom_mode", AP_Vehicle_register_custom_mode},
...
const luaL_Reg GCS_meta[] = {
    {"set_allow_param_set", GCS_set_allow_param_set},
    {"get_allow_param_set", GCS_get_allow_param_set},
#if HAL_HIGH_LATENCY2_ENABLED == 1
...
#endif // HAL_HIGH_LATENCY2_ENABLED == 1
    {"last_seen", GCS_sysid_mygcs_last_seen_time_ms},
    {"get_hud_throttle", GCS_get_hud_throttle},
    {"frame_type", GCS_frame_type},
    {"send_named_string", GCS_send_named_string},
...
const luaL_Reg RangeFinder_meta[] = {
    ...
    {"ground_clearance_orient", RangeFinder_ground_clearance_orient},
    {"min_distance_orient", RangeFinder_min_distance_orient},
    {"max_distance_orient", RangeFinder_max_distance_orient},
    ...
    {"distance_orient", RangeFinder_distance_orient},
...
const luaL_Reg AP_GPS_meta[] = {
    ...
    {"inject_data", lua_gps_inject_data},
};
...
const luaL_Reg AP_AHRS_meta[] = {
    ...
    {"get_relative_position_NED_origin", AP_AHRS_get_relative_position_NED_origin_float},
    ...
    {"get_yaw_rad", AP_AHRS_get_yaw_rad},
    {"get_pitch", AP_AHRS_get_pitch},
    {"get_pitch_rad", AP_AHRS_get_pitch_rad},
    {"get_roll", AP_AHRS_get_roll},
    {"get_roll_rad", AP_AHRS_get_roll_rad},
...
#if AP_SERVO_TELEM_ENABLED
static int AP_Servo_Telem__TelemetryData_last_update_ms(lua_State *L) {
    AP_Servo_Telem::TelemetryData *ud = check_AP_Servo_Telem__TelemetryData(L, 1);
    binding_argcheck(L, 1);
    *new_uint32_t(L) = ud->last_update_ms;
    return 1;
}

static int AP_Servo_Telem__TelemetryData_status_flags(lua_State *L) {
    AP_Servo_Telem::TelemetryData *ud = check_AP_Servo_Telem__TelemetryData(L, 1);
    binding_argcheck(L, 1);
    if ((ud->present_types & AP_Servo_Telem::TelemetryData::Types::STATUS) == 0) {
        return 0;
    }
    lua_pushinteger(L, ud->status_flags);
    return 1;
}

static int AP_Servo_Telem__TelemetryData_pcb_temperature_cdeg(lua_State *L) {
    AP_Servo_Telem::TelemetryData *ud = check_AP_Servo_Telem__TelemetryData(L, 1);
    binding_argcheck(L, 1);
    if ((ud->present_types & AP_Servo_Telem::TelemetryData::Types::PCB_TEMP) == 0) {
        return 0;
    }
    lua_pushinteger(L, ud->pcb_temperature_cdeg);
    return 1;
}

static int AP_Servo_Telem__TelemetryData_motor_temperature_cdeg(lua_State *L) {
    AP_Servo_Telem::TelemetryData *ud = check_AP_Servo_Telem__TelemetryData(L, 1);
    binding_argcheck(L, 1);
    if ((ud->present_types & AP_Servo_Telem::TelemetryData::Types::MOTOR_TEMP) == 0) {
        return 0;
    }
    lua_pushinteger(L, ud->motor_temperature_cdeg);
    return 1;
}

static int AP_Servo_Telem__TelemetryData_duty_cycle(lua_State *L) {
    AP_Servo_Telem::TelemetryData *ud = check_AP_Servo_Telem__TelemetryData(L, 1);
    binding_argcheck(L, 1);
    if ((ud->present_types & AP_Servo_Telem::TelemetryData::Types::DUTY_CYCLE) == 0) {
        return 0;
    }
    lua_pushinteger(L, ud->duty_cycle);
    return 1;
}

static int AP_Servo_Telem__TelemetryData_current(lua_State *L) {
    AP_Servo_Telem::TelemetryData *ud = check_AP_Servo_Telem__TelemetryData(L, 1);
    binding_argcheck(L, 1);
    if ((ud->present_types & AP_Servo_Telem::TelemetryData::Types::CURRENT) == 0) {
        return 0;
    }
    lua_pushnumber(L, ud->current);
    return 1;
}

static int AP_Servo_Telem__TelemetryData_voltage(lua_State *L) {
    AP_Servo_Telem::TelemetryData *ud = check_AP_Servo_Telem__TelemetryData(L, 1);
    binding_argcheck(L, 1);
    if ((ud->present_types & AP_Servo_Telem::TelemetryData::Types::VOLTAGE) == 0) {
        return 0;
    }
    lua_pushnumber(L, ud->voltage);
    return 1;
}

static int AP_Servo_Telem__TelemetryData_speed(lua_State *L) {
    AP_Servo_Telem::TelemetryData *ud = check_AP_Servo_Telem__TelemetryData(L, 1);
    binding_argcheck(L, 1);
    if ((ud->present_types & AP_Servo_Telem::TelemetryData::Types::SPEED) == 0) {
        return 0;
    }
    lua_pushnumber(L, ud->speed);
    return 1;
}

static int AP_Servo_Telem__TelemetryData_force(lua_State *L) {
    AP_Servo_Telem::TelemetryData *ud = check_AP_Servo_Telem__TelemetryData(L, 1);
    binding_argcheck(L, 1);
    if ((ud->present_types & AP_Servo_Telem::TelemetryData::Types::FORCE) == 0) {
        return 0;
    }
    lua_pushnumber(L, ud->force);
    return 1;
}

static int AP_Servo_Telem__TelemetryData_measured_position(lua_State *L) {
    AP_Servo_Telem::TelemetryData *ud = check_AP_Servo_Telem__TelemetryData(L, 1);
    binding_argcheck(L, 1);
    if ((ud->present_types & AP_Servo_Telem::TelemetryData::Types::MEASURED_POSITION) == 0) {
        return 0;
    }
    lua_pushnumber(L, ud->measured_position);
    return 1;
}

static int AP_Servo_Telem__TelemetryData_command_position(lua_State *L) {
    AP_Servo_Telem::TelemetryData *ud = check_AP_Servo_Telem__TelemetryData(L, 1);
    binding_argcheck(L, 1);
    if ((ud->present_types & AP_Servo_Telem::TelemetryData::Types::COMMANDED_POSITION) == 0) {
        return 0;
    }
    lua_pushnumber(L, ud->command_position);
    return 1;
}
...
#if AP_BATTERY_SCRIPTING_ENABLED
static int BattMonitorScript_State_state_of_health_pct(lua_State *L) {
    BattMonitorScript_State *ud = check_BattMonitorScript_State(L, 1);
    binding_argcheck(L, 2);
    const uint8_t raw_data_2 = get_uint8_t(L, 2);
    const uint8_t data_2 = static_cast<uint8_t>(raw_data_2);
    ud->state_of_health_pct = data_2;
    return 0;
}
...
#if HAL_ENABLE_DRONECAN_DRIVERS
static int DroneCAN_Handle_subscribe(lua_State *L) {
    binding_argcheck(L, 1);
    DroneCAN_Handle * ud = check_DroneCAN_Handle(L, 1);
    const bool data = static_cast<bool>(ud->subscribe());
...
#if AP_CRSF_SCRIPTING_ENABLED
static int CRSFMenu_num_params(lua_State *L) {
    binding_argcheck(L, 1);
    CRSFMenu * ud = check_CRSFMenu(L, 1);
    const uint8_t data = static_cast<uint8_t>(ud->num_params());
...
#if AP_CRSF_SCRIPTING_ENABLED
static int CRSFMenu_name(lua_State *L) {
    binding_argcheck(L, 1);
    CRSFMenu * ud = check_CRSFMenu(L, 1);
    const char * data = ud->name();
...
#if AP_CRSF_SCRIPTING_ENABLED
static int CRSFMenu_id(lua_State *L) {
    binding_argcheck(L, 1);
    CRSFMenu * ud = check_CRSFMenu(L, 1);
    const uint8_t data = static_cast<uint8_t>(ud->id());
...
#if AP_CRSF_SCRIPTING_ENABLED
static int CRSFParameter_id(lua_State *L) {
    binding_argcheck(L, 1);
...
static int AP_Scripting_SerialAccess_set_stop_bits(lua_State *L) {
    binding_argcheck(L, 2);
    AP_Scripting_SerialAccess * ud = check_AP_Scripting_SerialAccess(L, 1);
    const lua_Integer raw_data_2 = get_integer(L, 2, MAX(1, 0), MIN(2, UINT8_MAX));
    const uint8_t data_2 = static_cast<uint8_t>(raw_data_2);
    ud->set_stop_bits(
            data_2);
...
static int AP_Scripting_SerialAccess_configure_parity(lua_State *L) {
    binding_argcheck(L, 2);
    AP_Scripting_SerialAccess * ud = check_AP_Scripting_SerialAccess(L, 1);
...
static int Location_get_vector_from_origin_NEU(lua_State *L) {
    static bool warned = false;
    if (!warned) {
        lua_scripts::set_and_print_new_error_message(MAV_SEVERITY_WARNING, "(null):get_vector_from_origin_NEU Use get_vector_from_origin_NEU_cm or get_vector_from_origin_NEU_m");
        warned = true;
    }
...
#if AP_AHRS_ENABLED
static int Location_get_vector_from_origin_NEU_cm(lua_State *L) {
    binding_argcheck(L, 1);
    Location * ud = check_Location(L, 1);
    Vector3f data_5002 {};
    const bool data = static_cast<bool>(ud->get_vector_from_origin_NEU_cm(
            data_5002));
...
#if AP_AHRS_ENABLED
static int Location_get_vector_from_origin_NEU_m(lua_State *L) {
    binding_argcheck(L, 1);
    Location * ud = check_Location(L, 1);
    Vector3f data_5002 {};
    const bool data = static_cast<bool>(ud->get_vector_from_origin_NEU_m(
            data_5002));
...
#if HAL_ENABLE_DRONECAN_DRIVERS
const luaL_Reg DroneCAN_Handle_meta[] = {
    {"subscribe", DroneCAN_Handle_subscribe},
    {"check_message", DroneCAN_Handle::check_message},
    {"request", DroneCAN_Handle::request},
    {"broadcast", DroneCAN_Handle::broadcast},
};

const luaL_Reg DroneCAN_Handle_operators[] = {
    {"__gc", DroneCAN_Handle::__gc},
    {NULL, NULL},
};

static int DroneCAN_Handle_index(lua_State *L) {
    return load_function(L,DroneCAN_Handle_meta,ARRAY_SIZE(DroneCAN_Handle_meta));
}
#endif // HAL_ENABLE_DRONECAN_DRIVERS

#if AP_SERVO_TELEM_ENABLED
const luaL_Reg AP_Servo_Telem__TelemetryData_meta[] = {
    {"last_update_ms", AP_Servo_Telem__TelemetryData_last_update_ms},
    {"status_flags", AP_Servo_Telem__TelemetryData_status_flags},
    {"pcb_temperature_cdeg", AP_Servo_Telem__TelemetryData_pcb_temperature_cdeg},
    {"motor_temperature_cdeg", AP_Servo_Telem__TelemetryData_motor_temperature_cdeg},
    {"duty_cycle", AP_Servo_Telem__TelemetryData_duty_cycle},
    {"current", AP_Servo_Telem__TelemetryData_current},
    {"voltage", AP_Servo_Telem__TelemetryData_voltage},
    {"speed", AP_Servo_Telem__TelemetryData_speed},
    {"force", AP_Servo_Telem__TelemetryData_force},
    {"measured_position", AP_Servo_Telem__TelemetryData_measured_position},
    {"command_position", AP_Servo_Telem__TelemetryData_command_position},
};

static int AP_Servo_Telem__TelemetryData_index(lua_State *L) {
    return load_function(L,AP_Servo_Telem__TelemetryData_meta,ARRAY_SIZE(AP_Servo_Telem__TelemetryData_meta));
}
#endif // AP_SERVO_TELEM_ENABLED
...
#if AP_CRSF_SCRIPTING_ENABLED
const luaL_Reg CRSFMenu_meta[] = {
    {"num_params", CRSFMenu_num_params},
    {"name", CRSFMenu_name},
    {"id", CRSFMenu_id},
    {"add_menu", lua_CRSF_add_menu},
    {"add_parameter", lua_CRSF_add_parameter},
};

static int CRSFMenu_index(lua_State *L) {
    return load_function(L,CRSFMenu_meta,ARRAY_SIZE(CRSFMenu_meta));
}
#endif // AP_CRSF_SCRIPTING_ENABLED

#if AP_CRSF_SCRIPTING_ENABLED
const luaL_Reg CRSFParameter_meta[] = {
    {"id", CRSFParameter_id},
    {"data", lua_CRSF_param_data},
};

static int CRSFParameter_index(lua_State *L) {
    return load_function(L,CRSFParameter_meta,ARRAY_SIZE(CRSFParameter_meta));
}
#endif // AP_CRSF_SCRIPTING_ENABLED
...
const luaL_Reg AP_Scripting_SerialAccess_meta[] = {
    ...
    {"set_stop_bits", AP_Scripting_SerialAccess_set_stop_bits},
    {"configure_parity", AP_Scripting_SerialAccess_configure_parity},
...
const luaL_Reg BattMonitorScript_State_meta[] = {
    {"state_of_health_pct", BattMonitorScript_State_state_of_health_pct},
...
#endif // AP_AHRS_ENABLED
#if AP_AHRS_ENABLED
    {"get_vector_from_origin_NEU_cm", Location_get_vector_from_origin_NEU_cm},
#endif // AP_AHRS_ENABLED
#if AP_AHRS_ENABLED
    {"get_vector_from_origin_NEU_m", Location_get_vector_from_origin_NEU_m},
#endif // AP_AHRS_ENABLED
...
#if (!defined(HAL_BUILD_AP_PERIPH))
static int AP_Vehicle__custom_mode_state_allow_entry(lua_State *L) {
...
#if (AP_NETWORKING_ENABLED==1)
static int SocketAPM_is_pending(lua_State *L) {
    binding_argcheck(L, 1);
    SocketAPM * ud = *check_SocketAPM(L, 1);
    const bool data = static_cast<bool>(ud->is_pending());
...
const luaL_Reg SocketAPM_meta[] = {
    ...
    {"is_pending", SocketAPM_is_pending},
...
#if (!defined(HAL_BUILD_AP_PERIPH))
const luaL_Reg AP_Vehicle__custom_mode_state_meta[] = {
    {"allow_entry", AP_Vehicle__custom_mode_state_allow_entry},
};

static int AP_Vehicle__custom_mode_state_index(lua_State *L) {
    return load_function(L,AP_Vehicle__custom_mode_state_meta,ARRAY_SIZE(AP_Vehicle__custom_mode_state_meta));
}
#endif // (!defined(HAL_BUILD_AP_PERIPH))
...
#if HAL_ENABLE_DRONECAN_DRIVERS
    {"DroneCAN_Handle", DroneCAN_Handle::new_handle},
#endif // HAL_ENABLE_DRONECAN_DRIVERS
#if AP_FILESYSTEM_FILE_READING_ENABLED
...
#endif // AP_CAMERA_INFO_FROM_SCRIPT_ENABLED
#if AP_CRSF_SCRIPTING_ENABLED
    {"CRSFMenu", lua_CRSF_new_menu},
#endif // AP_CRSF_SCRIPTING_ENABLED
#if AP_CRSF_SCRIPTING_ENABLED
    {"CRSFParameter", lua_new_CRSFParameter},
#endif // AP_CRSF_SCRIPTING_ENABLED
#if AP_SCRIPTING_CAN_SENSOR_ENABLED
...
#if HAL_ENABLE_DRONECAN_DRIVERS
    {"DroneCAN_Handle", DroneCAN_Handle_index, DroneCAN_Handle_operators},
#endif // HAL_ENABLE_DRONECAN_DRIVERS
#if AP_SERVO_TELEM_ENABLED
    {"AP_Servo_Telem_Data", AP_Servo_Telem__TelemetryData_index, nullptr},
#endif // AP_SERVO_TELEM_ENABLED
#if AP_FILESYSTEM_FILE_READING_ENABLED
...
#endif // AP_CAMERA_INFO_FROM_SCRIPT_ENABLED
#if AP_CRSF_SCRIPTING_ENABLED
    {"CRSFMenu", CRSFMenu_index, nullptr},
#endif // AP_CRSF_SCRIPTING_ENABLED
#if AP_CRSF_SCRIPTING_ENABLED
    {"CRSFParameter", CRSFParameter_index, nullptr},
#endif // AP_CRSF_SCRIPTING_ENABLED
#if AP_SCRIPTING_CAN_SENSOR_ENABLED
...
#endif // AP_SIM_ENABLED
#if AP_SERVO_TELEM_ENABLED
    {"servo_telem", AP_Servo_Telem_index},
#endif // AP_SERVO_TELEM_ENABLED
#if AP_TEMPERATURE_SENSOR_ENABLED
...
#endif // AP_RC_CHANNEL_ENABLED
#if (!defined(HAL_BUILD_AP_PERIPH))
    {"AP_Vehicle::custom_mode_state", AP_Vehicle__custom_mode_state_index},
#endif // (!defined(HAL_BUILD_AP_PERIPH))
#if AP_RANGEFINDER_ENABLED
